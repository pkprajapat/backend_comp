...
##grades2
	db.himanshu.insert(user_id=1,description="yahoo lol 1",problem="Assignment 1")
	db.himanshu.insert(user_id=2,description="yahoo lol 2",problem="Assignment 2")
	db.himanshu.insert(user_id=3,description="yahoo lol 2",problem="Assignment 3")
	db.himanshu.insert(user_id=1,description="yahoo lol 3",problem="Assignment 4")
